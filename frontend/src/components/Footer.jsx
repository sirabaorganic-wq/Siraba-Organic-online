      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-xs text-white/60 font-light space-y-1 text-center md:text-left break-words max-w-full">
            <p className="break-words leading-relaxed">© 2026 Siraba Organic. All rights reserved. | Business Name: Siraba Organic | GSTIN: 06ACMPT6127H1ZA | URN: UDYAM-HR-05-0179395 | IEC Code: ACMPT6127H | APEDA RCMC No.: RCMC/APEDA/32995/2026–2027
