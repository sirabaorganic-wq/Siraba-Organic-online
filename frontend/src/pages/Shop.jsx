...
const Shop = () => {
  ...
  return (
    <div className="w-full pt-20 bg-background min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative z-10">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-text-secondary max-w-2xl mx-auto">
              Siraba Organic curates a focused range of premium organic
              ingredients from certified sources. Every product on our platform
              meets strict certification and compliance standards.
            </p>
            {!loading && (
      ...
      {/* Featured & Certification Info Section */}
      <div className="bg-white border-b border-emerald-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {/* Featured Coming Soon */}
          <div className="mb-10">
            <div className="inline-flex items-center gap-2 bg-amber-100 text-amber-700 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
              <Sparkles size={14} />
              Featured — Coming Soon
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Kashmiri Saffron */}
              <div className="flex gap-4 p-5 rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary mb-2">
                    Certified organic saffron sourced from high-altitude farms,
                    known for its deep color, aroma, and potency.
                  </p>
                  <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-amber-700 bg-amber-100 px-3 py-1 rounded-full">
                    <Info size={11} /> Status: Launching soon
                  </span>
                </div>
              </div>
              {/* Premium Asafoetida */}
              <div className="flex gap-4 p-5 rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white shadow-sm">
                <div className="w-12 h-12 flex-shrink-0 bg-emerald-100 rounded-xl flex items-center justify-center text-2xl">
                  🌿
                </div>
                <div>
                  <h3 className="font-heading text-lg font-bold text-primary mb-1">
                  ...
                  <p className="text-sm text-text-secondary mb-2">
                    Certified organic, export-grade asafoetida processed under
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-100">
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary mb-4">
                Alongside our flagship ingredients, Siraba lists products from
                vendors who meet our certification criteria. Only vendors with
                the following certifications are eligible for listing:
              </p>
              <div className="flex flex-wrap gap-3">
                {["USDA Organic", "EU Organic", "NPOP (India Organic)"].map(
                  (cert) => (
                    <span
                      key={cert}
