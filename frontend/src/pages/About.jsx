...
const About = () => {
  ...
  return (
    <div className="w-full bg-background text-primary selection:bg-accent selection:text-white">
          ...
          <div className="flex flex-col md:flex-row gap-16 lg:gap-24 items-center">
            ...
            <div className="w-full md:w-1/2 space-y-10 order-2 md:order-1 animate-slide-in-right">
              <div className="space-y-4">
                ...
                <h2 className="font-heading text-5xl md:text-6xl text-primary font-bold leading-tight">
                  Solving the Global <br />
                  <span className="italic text-accent">Trust Deficit</span>
                </h2>
              </div>
            ...
            <div className="w-full md:w-1/2 relative order-1 md:order-2 group">
              ...
              <div className="absolute -bottom-4 -left-4 bg-surface p-4 shadow-xl max-w-xs z-20 block text-left border border-secondary/10">
                ...
                <p className="text-[10px] text-accent uppercase tracking-[0.2em] mt-0.5 font-bold">
                  Founder & CEO
                </p>
              </div>
            </div>
      ...
      {/* Credentials / Founder Experience */}
      <section
        id="cred"
        className="py-20 bg-surface border-t border-secondary/10"
      >
      ...
      <section className="py-32 px-4 bg-background border-t border-secondary/10 flex items-center justify-center">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="pt-8">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 border-b-2 border-primary pb-1 text-primary font-bold uppercase tracking-widest hover:text-accent hover:border-accent transition-all"
            >
