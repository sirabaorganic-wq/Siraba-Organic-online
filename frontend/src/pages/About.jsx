              ...
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
                ...
                <div className="w-full lg:w-8/12 space-y-6">
                  ...
                  <div className="space-y-4 text-text-secondary font-light text-sm sm:text-base leading-relaxed">
                    ...
                    <p>
                      Throughout his professional journey, Sandeep has held key roles with leading organisations including <strong className="text-primary font-semibold">Johnson Matthey Group</strong>, <strong className="text-primary font-semibold">MMTC-PAMP India</strong> and <strong className="text-primary font-semibold">Hero Group</strong>, gaining extensive experience in gold and silver sourcing, precious-metals supply chains, raw-material planning, procurement, logistics and commercial coordination. He is also associated with <strong className="text-primary font-semibold">Sovereign Metals Limited</strong>, a leading gold and silver refinery in India, supporting logistics, sourcing and supply-chain operations.
                    </p>
                    <p>
